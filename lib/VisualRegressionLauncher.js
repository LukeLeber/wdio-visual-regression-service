...
var _wdioScreenshotService = require('wdio-screenshot-service');
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              this.viewportChangePause = _lodash2.default.get(browser.config, 'visualRegression.viewportChangePause', 100);
              this.viewports = _lodash2.default.get(browser.config, 'visualRegression.viewports');
              this.orientations = _lodash2.default.get(browser.config, 'visualRegression.orientations');
              _context2.next = 8;
            ...
            case 8:
              ...
              browser.addCommand('checkElement', this.wrapCommand(browser, 'element', _wdioScreenshotService.makeElementScreenshot));
              browser.addCommand('checkDocument', this.wrapCommand(browser, 'document', _wdioScreenshotService.makeDocumentScreenshot));
              browser.addCommand('checkViewport', this.wrapCommand(browser, 'viewport', _wdioScreenshotService.makeViewportScreenshot));
